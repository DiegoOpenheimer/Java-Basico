...
set CLASSPATH=%APP_HOME%\lib\socket.jar;%APP_HOME%\lib\dotenv-java-2.2.0.jar


@rem Execute socket
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %SOCKET_OPTS%  -classpath "%CLASSPATH%" com.openheimer.socket.App %*
